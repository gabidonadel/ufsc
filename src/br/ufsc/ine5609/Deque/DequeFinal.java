...
public class DequeFinal {
    ...
    void entrarPelaFrente(int dado){
        ...
        if(filaVazia()){//Adicionado para evitar que o ultimo seja nulo
            this.ult = novo;
        }
    ...
    */
    ...
    void entrarNoFim(int dado){
        Elemento novo = new Elemento(dado);
        if(!filaVazia()){//final nao está vazia
    ...
    */
    ...
    int sairDaFrente() throws Exception{
        if(filaVazia()){
    ...
    */
    ...
    int sairDoFim()  throws Exception{
        if(filaVazia()){
            throw new Exception("DEQUE Vazio!");
        }
        Elemento penultimo = this.prim;
        if(penultimo.getProx() == null){//nao é circualar errei 
            this.prim = null;
            this.ult = null;
    ...
    */
    ...
    boolean filaVazia(){
        ...
        Este método não foi emplementado na prova pois esqueci :/
    */
